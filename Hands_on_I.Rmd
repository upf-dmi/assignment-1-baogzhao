...
heart_data <- read.csv("/Users/jting/Downloads/assignment-1-arnaufme8-main/data/heart_disease_dataset.csv", sep = " ", header = TRUE, na.strings = c("?"))
...
```{r}
data <- read_excel("/Users/jting/Downloads/assignment-1-arnaufme8-main/data/mortality_rates_covid19.xlsx", col_names = TRUE) #Load data
...
```{r}
# Read excel:
df <- read_excel("/Users/jting/Downloads/assignment-1-arnaufme8-main/data/gene_expression.XLSX", col_names = TRUE, na=c("NI", "ND"), skip = 1) #skip 1st line (not header)
